...
public class EnrollmentController {
    ...
    public CommonResponse<PagedResponseDto<EnrollmentResponseDto>> getScheduledProgram(
    ...
    public CommonResponse<PagedResponseDto<EnrollmentResponseDto>> getInProgressProgram(
            @RequestParam(defaultValue = "1") int page,
            @AuthenticationPrincipal CustomOAuth2User userDetails) {
    ...
    public CommonResponse<PagedResponseDto<EnrollmentResponseDto>> getCompletedProgram(
            @RequestParam(defaultValue = "1") int page,
            @AuthenticationPrincipal CustomOAuth2User userDetails) {
